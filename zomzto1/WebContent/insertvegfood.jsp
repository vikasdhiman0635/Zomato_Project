...
<form action="coltrollerbtn" method="get">
	...
	<div class="row">
		<div class="col-md-3">
			...
			<b>---Or---</b> -->
			<!-- <div class="photobtn"> -->
            <input type="file" name="photo" class="updatephoto" size="50" required/>
			<!-- </div> -->
			</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-md-3">
			<input type="submit" class="btn" name="btn" value="Food Inserted" required/>
			</div>
		</div>
	</div>
</form>
